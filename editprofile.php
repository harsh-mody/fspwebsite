		...
		$conn =   mysqli_connect($host, $dbUsername, $dbPassword,$dbname,3307);
            ...
            <form method="post" action="updateprofile.php" >
					...
					<div class="wrap-input100 validate-input" >
						...
						<input class="input100"  type="text" name="username" placeholder="Enter UserName" value="<?php echo $row1["username"] ?>" readonly>
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: example@email-provider.com">
                        ...
                        <input class="input100" type="email" id="email" name="email" placeholder="Enter your email address" value="<?php echo $row1["email"]?>" readonly>
                        <span class="focus-input100"></span>
                    </div>
					...
					<div class="wrap-input100 validate-input" data-validate=""> 
                        ...
                        <input class="input100" type=text" id="password" name="password" placeholder="Enter a password" value="<?php echo $row1["password"] ?>" >
                        <span class="focus-input100"></span>
                    </div>
						...
						<div class="wrap-input100 validate-input" data-validate=data-validate = "Valid email is required: example@email-provider.com"> 
							<span class="label-input100"> Company Email</span>
							 <input  class="input100" type="text" name="Cemail" placeholder="Enter E-Mail" value="<?php echo $row2["Cemail"] ?>" required>
							 <span class="focus-input100"></span>
							</div> 
							<span class="focus-input100"></span>
							...
							<span class="label-input100"> Company Name</span>
							  <input  class="input100" type="text" name="cname" placeholder="Enter Company Name"  value="<?php echo $row2["cname"] ?>" required>
							  <span class="focus-input100"></span>
							</div>
							<span class="focus-input100"></span>  
						...
						<span class="label-input100">Description</span>
							 <input class="input100" type="text" name="desc"  value="<?php echo $row2["descrip"] ?>" required>
							 <span class="focus-input100"></span>
							</div>
							<span class="focus-input100"></span> 
						...
						<span class="label-input100"> Facebook Profile</span>
							 <input class="input100" type="text" name="facebook" placeholder="Enter Facebook Profile URL" value="<?php echo $row2["facebook"] ?>" required>
							<span class="focus-input100"></span>
							</div>
							<span class="focus-input100"></span>
						...
						<span class="label-input100"> LinkedIn Profile</span>
							 <input  class="input100"type="text" name="linkedin" placeholder="Enter LinkedIn Profile URL" value="<?php echo $row2["linkedin"] ?>" required>
							<span class="focus-input100"></span>
							</div>
							<span class="focus-input100"></span>
						...
						<span class="label-input100"> Phone Number</span>
							 <input  class="input100"type="text" name="phno" placeholder="Enter Phone number" value="<?php echo $row2["phno"] ?>" required>
							<span class="focus-input100"></span></div>
							<span class="focus-input100"></span>

							<div class="wrap-input100 validate-input" data-validate=""> 
						<span class="label-input100"> Location</label></span>
							 <input  class="input100" type="text" name="location" placeholder="Enter Location" value="<?php echo $row2["location"] ?>" required>
							<span class="focus-input100"></span></div>
							<span class="focus-input100"></span>
						<div class="wrap-input100 validate-input" data-validate=""> 
						<span class="label-input100">Interested In</span>
							 <input class="input100" type="text" name="interest" placeholder="FOR EG: Pipes" value="<?php echo $row2["interest"] ?>"required>
							 <span class="focus-input100"></span>
							</div>
							<span class="focus-input100"></span>
