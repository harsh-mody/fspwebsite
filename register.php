...
<div class="container-contact100">
			...
			<form method="post" action="UserCreate.php">
					...
					<div class="wrap-input100 validate-input" data-validate=""> 
                        ...
                        <input class="input100" type="password" id="password" name="password_1" placeholder="Enter a password" required>
                        <span class="focus-input100"></span>
                    </div>
                    ...
                    <div class="wrap-input100 validate-input" data-validate=""> 
                        ...
                        <input class="input100" type="password" id="password" name="password_2" placeholder="Enter a password" required>
                        <span class="focus-input100"></span>
                    </div>
